...
NEURON {
    ...
    RANGE gion
    RANGE i__Ca_HVA : a copy of the variable for current which makes it easier to access from outside the mod file
...
BREAKPOINT {
    ...
    ica = gion * (v - eca)
    i__Ca_HVA =  -1 * ica : set this variable to the current also - note -1 as channel current convention for LEMS used!
