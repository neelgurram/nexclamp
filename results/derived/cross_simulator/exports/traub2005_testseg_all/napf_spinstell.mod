...
NEURON {
    ...
    RANGE gion
    RANGE i__napf_spinstell : a copy of the variable for current which makes it easier to access from outside the mod file
...
PARAMETER {
    ...
    m_timeCourse_sh = -2.5                 : was: -2.5 (none)
    ...
    m_steadyState_sh = -2.5                : was: -2.5 (none)
...
BREAKPOINT {
    ...
    ina = gion * (v - ena)
    i__napf_spinstell =  -1 * ina : set this variable to the current also - note -1 as channel current convention for LEMS used!
