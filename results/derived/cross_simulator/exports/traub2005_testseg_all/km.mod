...
PARAMETER {
    ...
    m_forwardRate_rate = 0.020000001 (kHz) : was: 20.0 (per_time)
    m_forwardRate_midpoint = -20 (mV)      : was: -0.02 (voltage)
    m_forwardRate_scale = 5 (mV)           : was: 0.005 (voltage)
    m_reverseRate_rate = 0.010000001 (kHz) : was: 10.0 (per_time)
    m_reverseRate_midpoint = -43 (mV)      : was: -0.043000000000000003 (voltage)
