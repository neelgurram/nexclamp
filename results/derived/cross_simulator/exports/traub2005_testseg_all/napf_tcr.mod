...
NEURON {
    ...
    RANGE gion
    RANGE i__napf_tcr : a copy of the variable for current which makes it easier to access from outside the mod file
...
PARAMETER {
    ...
    m_timeCourse_fastNa_shift = 7          : was: 7.0 (none)
    ...
    m_steadyState_fastNa_shift = 7         : was: 7.0 (none)
...
BREAKPOINT {
    ...
    ina = gion * (v - ena)
    i__napf_tcr =  -1 * ina : set this variable to the current also - note -1 as channel current convention for LEMS used!
