...
Components:
    ...
    null (Type: notes)
    Input_4 (Type: pulseGenerator:  delay=0.02 (SI time) duration=0.06 (SI time) amplitude=8.0E-11 (SI current))
    network_Thalamocortical (Type: networkWithTemperature:  temperature=279.45 (SI temperature))
    sim1 (Type: Simulation:  length=0.1 (SI time) step=5.0E-7 (SI time))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt=None, seed=123456789, abs_tol=None, rel_tol=None):
        ...
        h("{ a_CG_CML[0].position(97.22775, 16.977047, 57.349842) }")
        ...
        h("objref Input_4_0")
        h("a_CG_CML[0].Soma { Input_4_0 = new Input_4(0.5) } ")
        ...
        # ######################   Display: self.display_CG_CML_v
        self.display_CG_CML_v = h.Graph(0)
        self.display_CG_CML_v.size(0,h.tstop,-80.0,50.0)
        self.display_CG_CML_v.view(0, -80.0, h.tstop, 130.0, 80, 330, 330, 250)
        h.graphList[0].append(self.display_CG_CML_v)
        # Line, plotting: CG_CML/0/TestSeg_all/v
        self.display_CG_CML_v.addexpr("a_CG_CML[0].Soma.v(0.5)", "a_CG_CML[0].Soma.v(0.5)", 1, 1, 0.8, 0.9, 2)
        ...
        # Line, plotting: CG_CML/0/TestSeg_all/caConc
        self.display_GraphWin_3.addexpr("a_CG_CML[0].Soma.cai(0.5)", "a_CG_CML[0].Soma.cai(0.5)", 1, 1, 0.8, 0.9, 2)
        ...
        h(' { v_v_CG_CML_v_0_0_OF.record(&a_CG_CML[0].Soma.v(0.5)) } ')
        ...
        # ######################   File to save: CG_CML_0.0.cad_CONC_ca.dat (Var_6_0_0_OF)
        # Column: CG_CML/0/TestSeg_all/caConc
        h(' objectvar v_caConc_Var_6_0_0_OF ')
        h(' { v_caConc_Var_6_0_0_OF = new Vector() } ')
        h(' { v_caConc_Var_6_0_0_OF.record(&a_CG_CML[0].Soma.cai(0.5)) } ')
        if self.abs_tol is None or self.rel_tol is None:

            h.v_caConc_Var_6_0_0_OF.resize((h.tstop * h.steps_per_ms) + 1)
    ...
    def save_results(self):
        ...
        self.display_CG_CML_v.exec_menu("View = plot")
        ...
        # ######################   File to save: CG_CML_0.0.cad_CONC_ca.dat (Var_6_0_0_OF). Note, saving in SI units
        py_v_caConc_Var_6_0_0_OF = [ float(x ) for x in h.v_caConc_Var_6_0_0_OF.to_python() ]  # Convert to Python list for speed, variable has dim: concentration

        f_Var_6_0_0_OF_f2 = open('CG_CML_0.0.cad_CONC_ca.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...

        for i in range(num_points):
            f_Var_6_0_0_OF_f2.write('%e\t%e\t\n' % (py_v_time[i], py_v_caConc_Var_6_0_0_OF[i], ))
        f_Var_6_0_0_OF_f2.close()
        print("Saved data to: CG_CML_0.0.cad_CONC_ca.dat")
...
if __name__ == '__main__':
    ...
    ns = NeuronSimulation(tstop=100.0, dt=5.0E-4, seed=123456789, abs_tol=None, rel_tol=None)
