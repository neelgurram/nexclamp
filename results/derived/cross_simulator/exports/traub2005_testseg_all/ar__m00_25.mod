...
NEURON {
    ...
    RANGE gion
    RANGE i__ar__m00_25 : a copy of the variable for current which makes it easier to access from outside the mod file
...
PARAMETER {
    ...
    m_timeCourse_m0 = 0.25                 : was: 0.25 (none)
...
BREAKPOINT {
    ...
    iar = gion * (v - ear)
    i__ar__m00_25 =  -1 * iar : set this variable to the current also - note -1 as channel current convention for LEMS used!
