...
NEURON {
    ...
    RANGE gion
    RANGE i__kahp : a copy of the variable for current which makes it easier to access from outside the mod file
...
BREAKPOINT {
    ...
    ik = gion * (v - ek)
    i__kahp =  -1 * ik : set this variable to the current also - note -1 as channel current convention for LEMS used!
