TITLE Mod file for component: Component(id=SampleIClamp type=pulseGenerator)
...
PARAMETER {
    ...
    weight = 1
    delay = 20 (ms)                        : was: 0.02 (time)
    duration = 60 (ms)                     : was: 0.06 (time)
    amplitude = 0.0038 (nA)                : was: 3.8E-12 (current)
}
