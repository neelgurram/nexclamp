...
NEURON {
    ...
    RANGE gion
    RANGE i__na3 : a copy of the variable for current which makes it easier to access from outside the mod file
...
PARAMETER {
    ...
    m_forwardRate_rate = 2.88 (kHz)        : was: 2880.0 (per_time)
    m_forwardRate_midpoint = -30 (mV)      : was: -0.03 (voltage)
    m_forwardRate_scale = 7.2 (mV)         : was: 0.007200000000000001 (voltage)
    m_reverseRate_rate = 0.89280003 (kHz)  : was: 892.8000000000001 (per_time)
    m_reverseRate_midpoint = -30 (mV)      : was: -0.03 (voltage)
    m_reverseRate_scale = -7.2 (mV)        : was: -0.007200000000000001 (voltage)
    m_timeCourse_TIME_SCALE = 1 (ms)       : was: 0.001 (time)
    m_timeCourse_VOLT_SCALE = 1 (mV)       : was: 0.001 (voltage)
    m_timeCourse_ar = 1                    : was: 1.0 (none)
    ...
    h_forwardRate_rate = 0.045 (kHz)       : was: 45.0 (per_time)
    h_forwardRate_midpoint = -45 (mV)      : was: -0.045 (voltage)
    h_forwardRate_scale = 1.5 (mV)         : was: 0.0015 (voltage)
    h_reverseRate_rate = 0.015000001 (kHz) : was: 15.0 (per_time)
    h_reverseRate_midpoint = -45 (mV)      : was: -0.045 (voltage)
    h_reverseRate_scale = -1.5 (mV)        : was: -0.0015 (voltage)
    h_timeCourse_TIME_SCALE = 1 (ms)       : was: 0.001 (time)
    h_timeCourse_VOLT_SCALE = 1 (mV)       : was: 0.001 (voltage)
    h_timeCourse_ar = 1                    : was: 1.0 (none)
    h_steadyState_TIME_SCALE = 1 (ms)      : was: 0.001 (time)
    h_steadyState_VOLT_SCALE = 1 (mV)      : was: 0.001 (voltage)
    h_steadyState_ar = 1                   : was: 1.0 (none)
...
BREAKPOINT {
    ...
    ina = gion * (v - ena)
    i__na3 =  -1 * ina : set this variable to the current also - note -1 as channel current convention for LEMS used!
