...
*2026-09-18T22:25:05+00:00; commit `292b7d877089eb8739cf062dc5199c1ba5e00b5d`; 2 trial(s); status: **FEASIBILITY PILOT (isolation partial; not the confirmatory agent study)**.*

- passed basic validation (schema, execution, canonical): **2 of 2**
- passed every layer: **1 of 2**
- **passed basic validation but failed the battery: 0 of 2**
...
|---|---|---|---|---|---|---|---|---|
| `t06_single_conductance_change__r01` | change_one_conductance | pass | pass | pass | pass | pass | pass | success |
| `t01_unit_repair__r01` | repair_seeded_unit_error | pass | pass | pass | pass | pass | error | indeterminate |
