...
NEURON {
    ...
    RANGE gion
    RANGE i__naChan : a copy of the variable for current which makes it easier to access from outside the mod file
...
PARAMETER {
    ...
    m_forwardRate_midpoint = -40 (mV)      : was: -0.04 (voltage)
    m_forwardRate_scale = 10 (mV)          : was: 0.01 (voltage)
    m_reverseRate_rate = 4 (kHz)           : was: 4000.0 (per_time)
    m_reverseRate_midpoint = -65 (mV)      : was: -0.065 (voltage)
    m_reverseRate_scale = -18 (mV)         : was: -0.018000000000000002 (voltage)
    h_instances = 1                        : was: 1.0 (none)
    h_forwardRate_rate = 0.07 (kHz)        : was: 70.0 (per_time)
    h_forwardRate_midpoint = -65 (mV)      : was: -0.065 (voltage)
    h_forwardRate_scale = -20 (mV)         : was: -0.02 (voltage)
    h_reverseRate_rate = 1 (kHz)           : was: 1000.0 (per_time)
    h_reverseRate_midpoint = -35 (mV)      : was: -0.035 (voltage)
...
BREAKPOINT {
    ...
    ina = gion * (v - ena)
    i__naChan =  -1 * ina : set this variable to the current also - note -1 as channel current convention for LEMS used!
