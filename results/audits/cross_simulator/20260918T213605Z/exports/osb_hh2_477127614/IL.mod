...
NEURON {
    ...
    RANGE gion
    RANGE i__IL : a copy of the variable for current which makes it easier to access from outside the mod file
...
PARAMETER {
    ...
    q_instances = 2                        : was: 2.0 (none)
    q_forwardRate_TIME_SCALE = 1 (ms)      : was: 0.001 (time)
    q_forwardRate_VOLT_SCALE = 1 (mV)      : was: 0.001 (voltage)
    q_reverseRate_TIME_SCALE = 1 (ms)      : was: 0.001 (time)
    q_reverseRate_VOLT_SCALE = 1 (mV)      : was: 0.001 (voltage)
    r_instances = 1                        : was: 1.0 (none)
    r_forwardRate_TIME_SCALE = 1 (ms)      : was: 0.001 (time)
    r_forwardRate_VOLT_SCALE = 1 (mV)      : was: 0.001 (voltage)
    r_reverseRate_TIME_SCALE = 1 (ms)      : was: 0.001 (time)
    r_reverseRate_VOLT_SCALE = 1 (mV)      : was: 0.001 (voltage)
}
...
BREAKPOINT {
    ...
    ica = gion * (v - eca)
    i__IL =  -1 * ica : set this variable to the current also - note -1 as channel current convention for LEMS used!
