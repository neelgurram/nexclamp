TITLE Mod file for component: Component(id=input_41 type=pulseGenerator)
...
PARAMETER {
    ...
    weight = 1
    delay = 270 (ms)                       : was: 0.27 (time)
    duration = 1000 (ms)                   : was: 1.0 (time)
    amplitude = 0.060000006 (nA)           : was: 6.0000004E-11 (current)
}
