...
NEURON {
    ...
    RANGE m_forwardRate_VT                  : derived variable
    RANGE m_reverseRate_V                   : derived variable
    RANGE m_reverseRate_VT                  : derived variable
    RANGE h_forwardRate_V                   : derived variable
    RANGE h_forwardRate_VT                  : derived variable
    RANGE h_reverseRate_V                   : derived variable
    RANGE h_reverseRate_VT                  : derived variable
...
PROCEDURE rates() {
    ...
    m_forwardRate_VT = -55 + (vShift /  m_forwardRate_VOLT_SCALE ) ? evaluable
    ...
    m_reverseRate_VT = -55 + (vShift /  m_reverseRate_VOLT_SCALE ) ? evaluable
    ...
    h_forwardRate_VT = -55 + (vShift /  h_forwardRate_VOLT_SCALE ) ? evaluable
    ...
    h_reverseRate_VT = -55 + (vShift /  h_reverseRate_VOLT_SCALE ) ? evaluable
