...
NEURON {
    ...
    RANGE gion
    RANGE i__nax__sh10 : a copy of the variable for current which makes it easier to access from outside the mod file
...
BREAKPOINT {
    ...
    ina = gion * (v - ena)
    i__nax__sh10 =  -1 * ina : set this variable to the current also - note -1 as channel current convention for LEMS used!
