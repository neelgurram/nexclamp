"""Unit tests for neurosem.analysis.bootstrap: exactness against scipy, cluster-level
...
from neurosem.analysis import bootstrap as B
from neurosem.analysis.bootstrap import SmallClusterWarning
...
@pytest.mark.filterwarnings("ignore::neurosem.analysis.bootstrap.SmallClusterWarning")
