"""Tests for nexclamp.protocols.rheobase.search and count_upward_crossings on fake spike counters.
...
from nexclamp.protocols.rheobase import RheobaseResult, count_upward_crossings, search
