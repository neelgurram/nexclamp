...
``src/nexclamp/protocols/definitions.py`` as overridden by ``configs/study.yaml``. Writing
...
from nexclamp.protocols.definitions import ProtocolTemplate, templates_from_config
...
# src/nexclamp/protocols/definitions.py, plus the rheobase search (protocols/rheobase.py).
