...
testing. How it is reported is a preregistration decision (`docs/STATISTICAL_ANALYSIS_PLAN.md`).
...
rate becomes zero by construction. The plan (`docs/STATISTICAL_ANALYSIS_PLAN.md`) therefore keeps
