...
from neurosem.provenance import sha256_file, utc_now, write_immutable_text

EXPLORATORY_PILOT = "exploratory_pilot"
DISCOVERY = "discovery"
CONFIRMATORY_HELDOUT = "confirmatory_heldout"
ROLES = (EXPLORATORY_PILOT, DISCOVERY, CONFIRMATORY_HELDOUT)
NON_CONFIRMATORY = frozenset({EXPLORATORY_PILOT, DISCOVERY})
