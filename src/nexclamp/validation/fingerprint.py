...
from nexclamp.schemas import ConcreteProtocol, ExecConfig, MutantClass, RunStatus, VariantRecord, to_jsonable
from nexclamp.validation.convergence import ToleranceTable
from nexclamp.validation.execution import RunRecorder, worst_status
...
def build_fingerprint(rec: RunRecorder, ws: Workspace, variant: VariantRecord, protocols: Sequence[ConcreteProtocol],
    ...
    from nexclamp.features.efel_adapter import FeatureValue
...
def fingerprint_to_json(fp: Fingerprint) -> dict[str, Any]:
    from nexclamp.features.efel_adapter import feature_table_to_json
...
def fingerprint_from_json(d: dict[str, Any]) -> Fingerprint:
    from nexclamp.features.efel_adapter import feature_table_from_json
