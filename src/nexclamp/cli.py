...
def cmd_select(a) -> int:
    from nexclamp.experiments.discovery import select_protocols
...
def cmd_heldout(a) -> int:
    from nexclamp.experiments.heldout import evaluate_heldout
...
def cmd_analyze(a) -> int:
    from nexclamp.experiments.analyze import analyze_campaign
...
def cmd_reproduce(a) -> int:
    from nexclamp.experiments.analyze import reproduce_paper
...
def cmd_curate(a) -> int:
    from nexclamp.orchestration.curation import run_curation
...
def cmd_smoke_test(a) -> int:
    from nexclamp.orchestration.smoke import FIXTURES, run_smoke
...
def build_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(prog="nexclamp", description=__doc__)
