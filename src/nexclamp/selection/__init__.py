...
lives in :mod:`nexclamp.selection.splits` and must be imported from there explicitly.
"""
...
from nexclamp.selection.matrix import DetectionMatrix, cell_step_costs
