...
from nexclamp.provenance import REPO_ROOT, utc_now


def evaluate_heldout(campaign: str, selection_file: Path, reason: str, workers: int | None = None) -> Path:
    from nexclamp.analysis import bootstrap
    from nexclamp.experiments import campaign as cp
    from nexclamp.experiments import registry, strata
    from nexclamp.selection.splits import HeldoutGate
