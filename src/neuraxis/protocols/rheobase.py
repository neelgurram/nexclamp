...
def make_step_counter(sim, ws, exec_cfg, *, settle_ms: float, step_ms: float, threshold_mV: float,
    ...
    ``sim`` is a :class:`neuraxis.simulators.base.Simulator`, ``ws`` a model workspace.
    ...
    from neuraxis.schemas import AnalysisWindow, ConcreteProtocol, RunStatus, StimulusComponent
