"""Deprecated alias of :mod:`nexclamp` (the project was renamed; DECISIONS D-057).

``import neuraxis.x`` returns the very same module object as ``import nexclamp.x``, so existing
