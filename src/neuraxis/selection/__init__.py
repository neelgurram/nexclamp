...
lives in :mod:`neuraxis.selection.splits` and must be imported from there explicitly.
"""
...
from neuraxis.selection.matrix import DetectionMatrix, cell_step_costs
