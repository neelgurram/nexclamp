...
def env_var(suffix: str, default: str | None = None) -> str | None:
    """``NEURAXIS_<suffix>``, falling back to the legacy ``NEUROSEM_<suffix>`` name."""
    return os.environ.get(f"NEURAXIS_{suffix}") or os.environ.get(f"NEUROSEM_{suffix}") or default
