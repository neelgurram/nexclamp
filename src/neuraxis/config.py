...
CONFIG_DIR_ENV = "NEURAXIS_CONFIG_DIR"
LEGACY_CONFIG_DIR_ENV = "NEUROSEM_CONFIG_DIR"


def config_dir() -> Path:
    value = os.environ.get(CONFIG_DIR_ENV) or os.environ.get(LEGACY_CONFIG_DIR_ENV)
    if not value:
        return CONFIG_DIR
    p = Path(value)
